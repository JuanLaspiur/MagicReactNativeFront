...
import MessageQuedadaHeader from "../../components/User/Messages/MessageQuedadaHeader";
...
function ChatRoomQuedada({ route }) {
    const { quedada, chat, mensajes } = route.params; 
  ...
  return (
    ...
    <MessageQuedadaHeader quedada={quedada} setterSurveyIDAndAsk={setterSurveyIDAndAsk} />
...
export default ChatRoomQuedada;
