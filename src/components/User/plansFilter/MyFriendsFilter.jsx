    ...
    <>
      ...
      <View style={styles.container}>
        <TouchableOpacity
          style={[
            styles.button,
            activeFilter === 'seguidores' ? styles.activeButton : styles.inactiveButton,
          ]}
          onPress={() => handleFilter('seguidores')}
        >
        ...
        <TouchableOpacity
          style={[
            styles.button,
            activeFilter === 'seguidos' ? styles.activeButton : styles.inactiveButton,
          ]}
          onPress={() => handleFilter('seguidos')}
        >
        ...
        <TouchableOpacity
          style={[
            styles.button,
            activeFilter === 'ambos' ? styles.activeButton : styles.inactiveButton,
          ]}
          onPress={() => handleFilter('ambos')}
        >
